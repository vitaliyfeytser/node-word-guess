...
function LetterConstructor(letter) {
    ...
    this.letter = letter;
    // PRESETS THE BOOLEAN VALUE OF THE LETTER-OBJECT TO FALSE TO DISPLAY AN UNDERSCORE
    this.boolean = false;
    ...
    // THIS FUNCTION TOGGLES THE BOOLEAN VALUE OF A LETTER-OBJECT TO TRUE IF MATCHED WITH USER GUESS
